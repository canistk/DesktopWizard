...
namespace Gaia
{
	...
	public class MeiCore : MonoBehaviour
	{
		private static MeiCore m_Instance;
		public static MeiCore instance => m_Instance;
		...
		private void InternalShowContextMenu()
		{
			...
			//m_ContextMenu.setting.StartPos = osPos;
		...
		public delegate void Cmd(MeiCore core);
